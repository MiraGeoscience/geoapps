...
class InversionTopography(InversionLocations):
    ...
    Methods
    -------
    active_cells: Return mask that restricts models to set of earth cells.
    ...
    def active_cells(self, mesh) -> np.ndarray:
        """
        Return mask that restricts models to set of earth cells.

        :param: mesh: Inversion mesh.
        :returns: active_cells: Mask that restricts a model to the set of
