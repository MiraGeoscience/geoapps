...
from .electric import DirectCurrentParams, InducedPolarizationParams
from .magnetotellurics import MagnetotelluricsParams
from .params import InversionBaseParams
from .potential_fields import GravityParams, MagneticScalarParams, MagneticVectorParams
